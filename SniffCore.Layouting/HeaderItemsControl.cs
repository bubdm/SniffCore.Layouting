...
namespace SniffCore.Layouting
{
    ...
    ///     <code lang="XAML">
    /// <![CDATA[
    /// <sniffCore:HeaderItemsControl>
    ///     <sniffCore:HeaderItem Header="Name">
    ///         <TextBox Text="{Binding Name}" />
    ///     </sniffCore:HeaderItem>
    ///     <sniffCore:HeaderItem Header="Family Name">
    ///         <TextBox Text="{Binding FamilyName}" />
    ///     </sniffCore:HeaderItem>
    ///     <sniffCore:HeaderItem Header="Age">
    ///         <TextBox Text="{Binding Age}" />
    ///     </sniffCore:HeaderItem>
    /// </sniffCore:HeaderdItemsControl>
    /// ]]>
    /// </code>
    /// </example>
    public class HeaderItemsControl : ItemsControl
    {
        ...
        public static readonly DependencyProperty HorizontalHeaderAlignmentsProperty =
            DependencyProperty.Register("HorizontalHeaderAlignments", typeof(HorizontalAlignment), typeof(HeaderItemsControl), new UIPropertyMetadata(HorizontalAlignment.Left));

        /// <summary>
        ///     Identifies the HeaderMargins dependency property.
        /// </summary>
        public static readonly DependencyProperty HeaderMarginsProperty =
            DependencyProperty.Register("HeaderMargins", typeof(Thickness), typeof(HeaderItemsControl), new UIPropertyMetadata(new Thickness(5, 0, 5, 0)));
        ...
        public static readonly DependencyProperty HorizontalContentAlignmentsProperty =
            DependencyProperty.Register("HorizontalContentAlignments", typeof(HorizontalAlignment), typeof(HeaderItemsControl), new UIPropertyMetadata(HorizontalAlignment.Stretch));
        ...
        public static readonly DependencyProperty VerticalContentAlignmentsProperty =
            DependencyProperty.Register("VerticalContentAlignments", typeof(VerticalAlignment), typeof(HeaderItemsControl), new UIPropertyMetadata(VerticalAlignment.Center));

        /// <summary>
        ///     Identifies the ContentMargins dependency property.
        /// </summary>
        public static readonly DependencyProperty ContentMarginsProperty =
            DependencyProperty.Register("ContentMargins", typeof(Thickness), typeof(HeaderItemsControl), new UIPropertyMetadata(new Thickness(0, 2, 0, 2)));

        /// <summary>
        ///     Identifies the Orientation dependency property.
        /// </summary>
        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register("Orientation", typeof(Orientation), typeof(HeaderItemsControl), new PropertyMetadata(Orientation.Vertical));
