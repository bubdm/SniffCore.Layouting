...
namespace SniffCore.Layouting
{
    ...
    public class HeaderItem : ContentControl
    {
        ...
        public static readonly DependencyProperty HeaderProperty =
            DependencyProperty.Register("Header", typeof(object), typeof(HeaderItem), new UIPropertyMetadata(null));

        /// <summary>
        ///     Identifies the HorizontalHeaderAlignment dependency property.
        /// </summary>
        public static readonly DependencyProperty HorizontalHeaderAlignmentProperty =
            DependencyProperty.Register("HorizontalHeaderAlignment", typeof(HorizontalAlignment), typeof(HeaderItem), new UIPropertyMetadata(HorizontalAlignment.Left));

        /// <summary>
        ///     Identifies the HeaderMargin dependency property.
        /// </summary>
        public static readonly DependencyProperty HeaderMarginProperty =
            DependencyProperty.Register("HeaderMargin", typeof(Thickness), typeof(HeaderItem), new UIPropertyMetadata(new Thickness(5, 0, 5, 0)));

        /// <summary>
        ///     Identifies the ContentMargin dependency property.
        /// </summary>
        public static readonly DependencyProperty ContentMarginProperty =
            DependencyProperty.Register("ContentMargin", typeof(Thickness), typeof(HeaderItem), new UIPropertyMetadata(new Thickness(0, 2, 0, 2)));
